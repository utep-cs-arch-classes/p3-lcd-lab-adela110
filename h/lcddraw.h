 ...
 *
 *  This draws a horizontal line from x_start to x_end at y height and color.
 */
...
/** Draw Diamond
 *  
 *  This draws a diamond with an x y origin at its center and expanding out to input width.
 *  Diamond x to y ratio is 1 : 2
 */
